...
test('score core loads before actual M8 fu and yaku evaluators',()=>{
 ...
 assert(index.includes('M8 v32')||index.includes('M7 v33')||index.includes('M7 v34')||index.includes('M7 v35')||index.includes('M7 v36')||index.includes('M7 v37')||index.includes('M7 v38')||index.includes('M7 v39'));
});
